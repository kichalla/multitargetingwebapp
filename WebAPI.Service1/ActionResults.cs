...
{
    internal interface IStatusCodeActionResult : IActionResult
    {
    ...
    internal class AcrStatusCodeResult : IStatusCodeActionResult
    {
    ...
    internal class AcrObjectResult<TValue> : IStatusCodeActionResult
    {
